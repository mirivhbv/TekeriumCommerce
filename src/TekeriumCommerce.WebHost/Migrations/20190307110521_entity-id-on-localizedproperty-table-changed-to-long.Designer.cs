...
namespace TekeriumCommerce.WebHost.Migrations
{
    ...
    [Migration("20190307110521_entity-id-on-localizedproperty-table-changed-to-long")]
    partial class entityidonlocalizedpropertytablechangedtolong
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TekeriumCommerce.Infrastructure.Localization.Culture", b =>
                {
            ...
            modelBuilder.Entity("TekeriumCommerce.Infrastructure.Localization.Resource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TekeriumCommerce.Module.Core.Models.LocalizedProperty", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("Core_LocalizedProperty");
                });
            ...
            modelBuilder.Entity("TekeriumCommerce.Module.Orders.Models.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TekeriumCommerce.Module.Orders.Models.OrderHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TekeriumCommerce.Module.Orders.Models.OrderItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TekeriumCommerce.Infrastructure.Localization.Resource", b =>
                {
                    b.HasOne("TekeriumCommerce.Infrastructure.Localization.Culture", "Culture")
                        .WithMany("Resources")
            ...
            modelBuilder.Entity("TekeriumCommerce.Module.Core.Models.LocalizedProperty", b =>
                {
                    b.HasOne("TekeriumCommerce.Module.Catalog.Models.Category")
                        .WithMany("Locales")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("TekeriumCommerce.Module.Orders.Models.Order", b =>
                {
                    ...
                    b.HasOne("TekeriumCommerce.Module.Shipping.Models.City", "ShippingCity")
                        .WithMany()
            ...
            modelBuilder.Entity("TekeriumCommerce.Module.Orders.Models.OrderHistory", b =>
                {
                    ...
                    b.HasOne("TekeriumCommerce.Module.Orders.Models.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("TekeriumCommerce.Module.ShoppingCart.Models.Cart", b =>
                {
                    b.HasOne("TekeriumCommerce.Module.Shipping.Models.City", "City")
                        .WithMany()
